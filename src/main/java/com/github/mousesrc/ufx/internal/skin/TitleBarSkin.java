...
import com.github.mousesrc.ufx.window.TitleBar;
...
public class TitleBarSkin extends SkinBase<TitleBar> {
	...
	private ObservableList<Node> rightNodes;
	...
	private void init() {
		...
		rightNodes = getSkinnable().getRightNodes();
		rightNodes.addListener(new ListChangeListener<Node>() {
